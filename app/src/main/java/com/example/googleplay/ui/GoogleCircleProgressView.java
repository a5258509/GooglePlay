 ...
 * platforms.
 */
public class GoogleCircleProgressView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int viewWidth = com.example.googleplay.ui.GoogleCircleProgressView.this.getWidth();
            final int viewHeight = com.example.googleplay.ui.GoogleCircleProgressView.this.getHeight();
